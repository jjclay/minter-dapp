...
const layerConfigurations = [
  ...
  // 1 with frame
  {
    ...
    layersOrder: [
      ...
      { name: "black/stickmen/arm left" },
      { name: "black/stickmen/arm right" },
      { name: "black/stickmen/leg left" },
      { name: "black/stickmen/leg right" },
  ...
  // trump
  {
    ...
    layersOrder: [
      ...
      { name: "black/theme color" },
      { name: "black/background" },
      { name: "black/stickmen/trump jail bars" },
      { name: "black/locations/top 64" },
      { name: "black/locations/top 32" },
      { name: "black/locations/bottom 64" },
      { name: "black/locations/bottom 32" },
      { name: "black/stickmen/trump head" },
      { name: "black/stickmen/trump hair" },
      { name: "black/stickmen/trump eyes" },
      { name: "black/stickmen/trump eyebrows" },
      { name: "black/stickmen/trump mouth" },
      { name: "black/stickmen/body" },
      { name: "black/stickmen/trump arm left" },
      { name: "black/stickmen/trump arm right" },
      { name: "black/stickmen/trump penis" },
      { name: "black/stickmen/trump leg left" },
      { name: "black/stickmen/trump leg right" },
  ...
  // 1 with frame
  {
    ...
    layersOrder: [
      ...
      { name: "white/stickmen/arm left" },
      { name: "white/stickmen/arm right" },
      { name: "white/stickmen/leg left" },
      { name: "white/stickmen/leg right" },
  ...
  // trump
  {
    ...
    layersOrder: [
      ...
      { name: "white/theme color" },
      { name: "white/background" },
      { name: "white/stickmen/trump jail bars" },
      { name: "white/locations/top 64" },
      { name: "white/locations/top 32" },
      { name: "white/locations/bottom 64" },
      { name: "white/locations/bottom 32" },
      { name: "white/stickmen/trump head" },
      { name: "white/stickmen/trump hair" },
      { name: "white/stickmen/trump eyes" },
      { name: "white/stickmen/trump eyebrows" },
      { name: "white/stickmen/trump mouth" },
      { name: "white/stickmen/body" },
      { name: "white/stickmen/trump arm left" },
      { name: "white/stickmen/trump arm right" },
      { name: "white/stickmen/trump penis" },
      { name: "white/stickmen/trump leg left" },
      { name: "white/stickmen/trump leg right" },
  ...
  //center small stickman
  {
    ...
    layersOrder: [
      ...
      { name: "black/locations/top 32" },
      { name: "black/locations/bottom 32" },
      { name: "black/stickmen/head medium" },
      { name: "black/stickmen/eyes" },
      { name: "black/stickmen/mouth" },
      { name: "black/stickmen/body" },
      { name: "black/stickmen/arm left" },
      ...
      { name: "black/stickmen/leg left" },
      { name: "black/stickmen/leg right" },
      { name: "black/locations/center small stickman" },
  ...
  //center medium
  {
    ...
    layersOrder: [
      ...
      { name: "black/theme color" },
      { name: "black/background" },
      { name: "black/locations/center medium" },
      { name: "black/shapes/lines diagonal shooting" },
  ...
  //center large
  {
    ...
    layersOrder: [
      ...
      { name: "black/theme color" },
      { name: "black/background" },
      { name: "black/locations/center large" },
      { name: "black/shapes/lines diagonal shooting" },
